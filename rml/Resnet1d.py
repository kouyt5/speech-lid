...
class ResNet1D(nn.Module):
    ...
    def __init__(
        ...
        if self.rnn:
            self.context_rnn = BatchLSTM(in_ch=base_filters, out_ch=base_filters // 2, batch_first=True, bidirection=True,num_layers=1)
        # first block
...
if __name__ == "__main__":
    model = ResNet1D(2, 128, kernel_size=5, stride=2, groups=1, n_block=4, n_classes=11,rnn=True)
