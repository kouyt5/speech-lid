...
from s3prl_updream.helper import show
...
class Featurizer(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        with torch.no_grad():
            paired_features = self.upstream(paired_wavs)
        ...
        if hasattr(self.upstream, "get_downsample_rates"):
            self.downsample_rate = self.upstream.get_downsample_rates(feature_selection)
            show(
